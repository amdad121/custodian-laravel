...
namespace AmdadulHaq\Custodian\Tests;

use AmdadulHaq\Custodian\CustodianServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    {
        return [
            CustodianServiceProvider::class,
        ];
    }
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        config()->set('custodian.models.user', User::class);
